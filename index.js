const contentLetterSrart_actived = "Gửi vợ yêu của anh chúc vợ sinh nhật vui vẻ." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc em yêu sinh nhật vui vẻ và có những phút giây thật tuyệt vời bên bạn bè và người thân trong ngày quan trọng này. Mặc dù anh không ở bên êm vào lúc này nhưng anh hi vọng rằng em sẽ luôn vui vẻ, thành công và hạnh phúc trong cuộc sống em nhé! Happy birthday to you." //Nội dung của bức thư
